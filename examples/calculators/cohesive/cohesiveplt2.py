...
# x 轴单位用上标 A^3
plt.xlabel(r'Volume ($\mathrm{\AA}^3$)', fontsize=15)
plt.ylabel('Energy (eV)', fontsize=15)

# 去掉原来的标题，把 “FCC-Cu” 写到图里
# 位置可以根据需要微调，比如 (0.15, 0.88)
plt.text(
    0.15, 0.88, 'BCC-CuZn',
...
plt.tight_layout()
plt.savefig('energy_vs_volume_cohesive.png', dpi=1000)
plt.close()
